...
| `work/hns-wallet-rs` | `5c5a13d4816be620475f6aa714f868449e964678` | private wallet service ABI v2, zeroizing transport buffers, dedicated Bitcoin atomic-swap derivation, provider-authority hardening, and exact node fee-quote adoption remain present; the legacy Shakedex 0.1 journal is now explicitly unable to create, discover, or advance seller/buyer sessions until canonical V2, Denuo V2, and value-runtime release gates are qualified; HNS value, product wiring, and qualification remain unavailable |
