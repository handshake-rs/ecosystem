...
| `work/hns-wallet-rs` | independently created local `main`; latest source-only head `4935e059bcde338f4260dd98202ff26ce0f3ca9f`; configured `origin` `https://github.com/denuoweb/hns-wallet-rs.git` with remote-tracking `main` `1206a8ab550cf67ff43dc162091e371946278641`; local `main` is ahead by eight commits, unpushed, and has no push authorization; private ABI/host/schema source exists but no published/signed ABI artifact or verifier |
...
| `work/hns-dane-browser-mobile` | latest local source-only head `4b684ebbb576c2b2f8e762c3f81c3ec2fded47f5`, ahead of remote-tracking `main` `58996db0facef1bb6a7cb2876361d13dabc90c75` by two unpushed commits; Android 0.5.5/version-code-46 source `d24f85158854abb8be4a7bb9e914aebe5e7e4679`; iOS 0.5.5/build-57 source and `v0.5.5` tag `d926561091634cd69fc9b7e79a4b76003fa4ee47`; documentation head `39ea427b744581ccc9a860f5f51f6fc31622d317` |
| `work/hns-dane-browser-extension` | latest local source-only head `972e63a14f9067da3608f53b852adc93d8ded2a4`, ahead of remote-tracking `main` by three commits (including ABI-v2 documentation commit `06bea8893ea7e2324d0df7e5b486fb3cf91f9cdd`); public v0.5.5 source/tag `86b18497285753944ec1b9196ec05ee359c6db11`; documentation head `3495bd1c5e7c26f9486ea81fb21dc1618c9bc2c8` |
